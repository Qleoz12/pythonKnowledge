...
if __name__ == '__main__':
    ...
    URL="http://localhost:8080/soap/esb/services/soap/173"
    r = requests.post(URL)
    archivo = json.loads(json.dumps(xmltodict.parse(r.content)['soap:Envelope']['soap:Body']['v1:GeneracionFormularioTramiteCreditoRs']['infArchivo']))
    ...
    base64_img_bytes = archivo['datosArchivo'].encode('utf-8')
    decoded_image_data = base64.decodebytes(base64_img_bytes)

    pages = convert_from_bytes(decoded_image_data, 500)
