...
def decrypt(text, encrypt, sha, dsa_data, iv):
    ...
    if (len(str(decrypt.decode("utf-8")))<923 or len(str(decrypt.decode("utf-8")))>926 or not decrypt.decode("utf-8").isnumeric()):
        raise Exception('Fallo', 'error validacion confidencialidad')
...
if __name__ == '__main__':
    ...
    textmodificado = "The standard Lorem Ipsum passage, used since the 1500s" \
           "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et " \
           "dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip " \
           "ex ea commodo" \
           "consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla " \
